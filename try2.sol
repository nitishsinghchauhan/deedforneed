...
contract Donation {
   ...
   // make events for frontend - Donate,getbal,refund
    ...
    function makeRequest(string memory _description, uint32 _startAt, uint32 _id, address payable _p,uint _maxAmt) public  {
    ...
    function msgVal()payable public returns(uint)  {
         return msg.value;
    }
